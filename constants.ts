...
// Primary Coordinates extracted directly from the provided GPX file
export const COORDS = {
  // Civitavecchia Zone
  SHUTTLE_CRUCERO: { lat: 42.097499, lng: 11.788778 },
  ESTACION_FFCC_CIVITAVECCHIA: { lat: 42.087946, lng: 11.7983 },
  ...
  VISTA_FORO_IZQ: { lat: 41.891274, lng: 12.490416 },
  ESCALERAS: { lat: 41.89401, lng: 12.483923 },
  ...
  PUENTE_SANT_ANGELO: { lat: 41.901901, lng: 12.466464 },
...
export const INITIAL_ITINERARY: Activity[] = [
  {
    id: '1',
    title: 'Desembarco y Shuttle',
    startTime: '07:15',
    endTime: '07:45',
    locationName: 'Puerto Civitavecchia',
    coords: COORDS.SHUTTLE_CRUCERO,
    description: 'Atraco del barco y salida inmediata hacia el punto de shuttle.',
    keyDetails: 'El Shuttle gratuito te deja en Largo della Pace.',
    priceNOK: 0,
    priceEUR: 0,
    type: 'logistics',
    completed: false
  },
  {
    ...
    coords: COORDS.PARADA_AUTOBUS,
    endCoords: COORDS.ESTACION_FFCC_CIVITAVECCHIA,
    description: 'Toma el bus urbano o camina hacia la estación de tren.',
    keyDetails: 'Compra el billete BIRG (12€) en el quiosco de la estación.',
    priceNOK: 0,
    priceEUR: 12,
    type: 'transport',
    completed: false,
  ...
  {
    id: '3',
    title: 'Tren Regional a Roma',
    startTime: '08:36',
    endTime: '09:48',
    locationName: 'Civitavecchia',
    endLocationName: 'Roma Termini',
    coords: COORDS.ESTACION_FFCC_CIVITAVECCHIA,
    endCoords: COORDS.ROMA_TERMINI,
    description: 'Tren Regional Veloce directo a Termini.',
    keyDetails: 'Siéntate al lado derecho para ver el mar.',
    priceNOK: 0,
    priceEUR: 0,
    type: 'transport',
    completed: false,
    notes: 'Aviso: Tren de las 08:58 como reserva.'
  },
  {
    id: '4',
    title: 'Coliseo y Arco',
    startTime: '10:15',
    endTime: '11:00',
    locationName: 'Colosseo',
    coords: COORDS.COLISEO,
    description: 'Llegada al centro imperial de Roma.',
    keyDetails: 'Mejor foto desde el muro de Via Nicola Salvi.',
    priceNOK: 0,
    priceEUR: 0,
    type: 'sightseeing',
    completed: false
  ...
  {
    id: '5',
    title: 'Foro y Campidoglio',
    startTime: '11:00',
    endTime: '12:00',
    locationName: 'Campidoglio',
    coords: COORDS.CAMPIDOGLIO,
    description: 'Paseo por los Foros Imperiales hasta la plaza diseñada por Miguel Ángel.',
    keyDetails: 'Busca la estatua de la Loba Capitolina.',
    priceNOK: 0,
    priceEUR: 0,
    type: 'sightseeing',
    completed: false
  },
  {
    ...
    locationName: 'Trevi',
    coords: COORDS.TREVI,
    description: 'Lanzamiento de moneda obligatorio.',
    keyDetails: 'Control de aforo activo, no se puede comer en las escaleras.',
    priceNOK: 0,
    priceEUR: 0,
    type: 'sightseeing',
    completed: false
  },
  {
    ...
    description: 'Visita exterior y pizza al taglio en los alrededores.',
    keyDetails: 'Prueba la pizza de "La Rosetta" o similares cerca de Navona.',
    priceNOK: 0,
    priceEUR: 15,
    type: 'food',
    completed: false
  ...
  {
    id: '8',
    title: 'San Pedro y Regreso',
    startTime: '14:15',
    endTime: '14:45',
    locationName: 'San Pietro',
    coords: COORDS.SAN_PEDRO,
    description: 'Paseo rápido por la columnata de Bernini.',
    keyDetails: 'Caminata final hacia la estación de San Pietro.',
    priceNOK: 0,
    priceEUR: 0,
    type: 'sightseeing',
    completed: false
  },
  {
    ...
    endCoords: COORDS.ESTACION_FFCC_CIVITAVECCHIA,
    description: 'Tren de vuelta al puerto para evitar el caos de Termini.',
    keyDetails: 'No pierdas este tren, el siguiente deja poco margen.',
    priceNOK: 0,
    priceEUR: 0,
    type: 'transport',
    completed: false,
  ...
  },
  {
    ...
    locationName: 'Muelle',
    coords: COORDS.SHUTTLE_CRUCERO,
    description: 'Regreso final y subida al barco.',
    keyDetails: 'A bordo antes de las 17:30.',
    priceNOK: 0,
    priceEUR: 0,
    type: 'logistics',
    completed: false,
